        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-balance text-3xl font-bold tracking-tight text-primary-foreground sm:text-4xl md:text-5xl lg:text-6xl">
              Encontre o carro ideal com quem entende de veículos
            </h1>
            ...
            <p className="mt-6 text-pretty text-lg leading-relaxed text-primary-foreground/80 sm:text-xl">
              ...
              Veículos. Veículos selecionados, condições facilitadas e suporte
              completo para você fazer o melhor negócio.
            </p>
          ...
          <div className="relative mx-auto w-full max-w-lg lg:max-w-none">
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl">
              <Image
                src="/tiguan-r-line.jpg"
                alt="Volkswagen Tiguan R-Line disponível na Pirâmide Veículos"
                fill
